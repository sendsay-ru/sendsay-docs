...
Если вы импортировали подписчиков, и они получили неподтверждённый статус, вы можете активировать их двумя способами: отправить им письма подтверждения или, если подтверждения у вас уже есть, <SupportLink>написать нам в чат поддержки</SupportLink>.
