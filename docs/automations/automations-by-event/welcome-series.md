...
Чтобы приветственная цепочка запускалась после подтверждения формы, [созданной в разделе **Формы**](https://docs.sendsay.ru/forms/signup-forms#как-создать-форму), необходимо выбрать тип автоматизации «Своя последовательность» и указать в качестве исходного событие «Форма подтверждена».

[Как создать приветственную серию со своим сценарием](https://docs.sendsay.ru/automations/automations-by-event/welcome-series#как-создать-приветственную-серию-со-своим-сценарием)
...
:::tip Важно
Подписчикам без потверждения можно отправлять только письма подтверждения, с помощью которых они смогут подтвердить свое согласие на рассылку.
:::
