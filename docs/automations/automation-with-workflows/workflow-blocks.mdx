...
:::tip Важно
Событие **Email доставлен** учитывается только для транзакционных писем. Чтобы Событие сработало, необходимо проставить галочку у пункта **После доставки запускать событие «Email доставлен» для сценариев** в дополнительных настройках при отправке выпуска.
:::
