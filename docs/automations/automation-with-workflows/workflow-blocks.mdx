...
import terms from '/img/automations/automation-with-workflows/workflow-blocks/terms.png';
import listTerms from '/img/automations/automation-with-workflows/workflow-blocks/list-terms.png';
import dataTerms from '/img/automations/automation-with-workflows/workflow-blocks/data-terms.png';
...
3. Под каждым блоком Событий нажмите кнопку плюса `+` и&nbsp;разместите блоки необходимых действий.<br/><br/>
   ![How to create several branche](/img/automations/automation-with-workflows/workflow-blocks/how-to-create-several-branches.gif)
...
Блок Условия поможет офильтровать подписчиков в&nbsp;сценарии. Он&nbsp;проверяет соблюдение определенного условия:

- Если подписчик Есть&nbsp;/ Нет в&nbsp;списке,
- Если данные подписчика соответствуют.

<p align="center">
  <img width="50%" src={terms} alt="Terms" />
</p>

Таким образом можно разделить участников сценария на&nbsp;разные ветки. Другими словами, если Условие выполнится, участники сценария пойдут по&nbsp;одной ветке, если нет&nbsp;&mdash; по&nbsp;другой:

![Branching with terms](/img/automations/automation-with-workflows/workflow-blocks/branching-with-terms.png)

[Разветвления Событий в сценарии](#разветвления-событий-в-сценарии)

Чтобы настроить Условия для разветвления веток в&nbsp;сценарии, нажмите плюс `+` под необходимым блоком и&nbsp;выберите нужное Условие, настроив его параметры.

### Виды Условий

**Если подписчик Есть / Нет в списке** — участник сценария перейдёт на следующий шаг в зависимости от того, состоит он или нет в указанном списке. Здесь есть два варианта:

<p align="center">
  <img width="50%" src={listTerms} alt="List terms" />
</p>
...
**Если данные соответствуют**&nbsp;&mdash; подписчик перейдёт на&nbsp;следующий шаг сценария, если его данные соответствуют указанным. Таким образом в&nbsp;сценарии можно отфильтровать тех участников, чьи данные подходят под определенные значения:

<p align="center">
  <img width="50%" src={dataTerms} alt="Data terms" />
</p>

Например, с&nbsp;помощью такого Условия можно разделить базу на&nbsp;списки:

![How to divide into lists by terms](/img/automations/automation-with-workflows/workflow-blocks/how-to-divide-into-lists-by-terms.png)
...
Это может понадобится, например, если в&nbsp;сценарии не&nbsp;выполняется какое-то Условие:
