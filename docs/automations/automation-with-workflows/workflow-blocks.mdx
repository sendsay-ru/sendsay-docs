...
**Email доставлен** — сработает, когда любое или выбранное письмо будет успешно доставлено.
...
:::tip Важно
Событие **Email доставлен** учитывается только для транзакционных писем, отправленных вне сценария. Чтобы Событие сработало, необходимо проставить галочку у пункта **После доставки запускать событие «Email доставлен» для сценариев** в дополнительных настройках при отправке выпуска.
:::
...
**Отправить email подтверждения** — система отправит участнику сценария выбранное письмо подтверждения. В шаблоне должна быть указана специальная ссылка, при клике на которую пользователь подтвердит свою подписку на рассылку.
