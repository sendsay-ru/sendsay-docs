...
### Формирование ссылки на бота в рассылке
...
### Формирование ссылки на бота с указанием только емейла

Если вы предлагаете подписаться на Телеграм-бота на сайте или в приложении, то вы можете сформировать ссылку на бота с указанием емейла (если он вам известен).

```
<a href="https://t.me/example_bot?start=PAYLOAD">Подписаться в Telegram</a>

PAYLOAD &mdash; это закодированная в base64 строка 'email=qwerty@mail.ru' (без кавычек)
```

Если такой адрес есть у вас в аккаунте, то телеграм-токен будет добавлен к указанному емейлу, как дополнительная голова.
