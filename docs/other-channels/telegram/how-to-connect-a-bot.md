...
### Формирование ссылки на бота с указанием только email

Если вы предлагаете подписаться на Телеграм-бота на сайте или в приложении, то вы можете сформировать ссылку на бота с указанием email (если он вам известен).
...
Если такой адрес есть у вас в аккаунте, то телеграм-токен будет добавлен к указанному email, как дополнительный контакт.
