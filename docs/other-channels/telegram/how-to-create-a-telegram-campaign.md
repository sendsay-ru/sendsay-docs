...
![](/img/other-channels/telegram/how-to-create-a-telegram-campaign/how-to-add-a-link.jpg)
...
![How to add a picture](/img/other-channels/telegram/how-to-create-a-telegram-campaign/add-picture.jpg)
...
1. Нажмите «Добавить кнопку» под блоком с текстом или картинкой. Для одной рассылки можно добавить до 8 кнопок в ряд и 8 в столбец.
   ...
   ![](/img/other-channels/telegram/how-to-create-a-telegram-campaign/how-to-add-a-key.jpg)
...
- **Удалить из чата предыдущее меню быстрых ответов** — если в новой рассылке нет быстрых ответов, из чата удалится предыдущее меню.
...
Функция оптимизации времени подключается отдельно — чтобы еёактивировать, напишите в техподдержку.
