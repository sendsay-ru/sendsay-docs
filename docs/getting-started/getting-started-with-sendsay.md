...
## Программный продукт Sendsay

У Sendsay есть свой программный продукт с полным функционалом сервиса — это десктопное приложение для работы в операционной системе Windows. Приложение можно бесплатно скачать и установить на свой компьютер для удобства пользования сервисом. Для этого перейдите [по ссылке](https://sendsay.ru/about/ustanovka-sendsay). 
