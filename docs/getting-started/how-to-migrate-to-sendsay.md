...
Миграция из другого сервиса рассылок проще, чем кажется. Чтобы перейти из&nbsp;другого сервиса в&nbsp;Sendsay&nbsp;&mdash; полностью российское решение для автоматизации маркетинга,&nbsp;&mdash; необходимо:
...
<p align="center">
  <img width="50%" src={exportContactsDashamail} alt="Export contacts from DashaMail" />
</p>
...
### 10. Отключите API-интеграцию со&nbsp;старой платформой (опционально)​
